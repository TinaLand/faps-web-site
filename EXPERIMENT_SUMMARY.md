...
Curated qualitative clips and figures:

| Artifact | What it demonstrates |
|---|---|
| `demo_videos/pair_ep006_unshielded_fail.mp4` | Unshielded action-noise timeout in a paired rescue case. |
| `demo_videos/pair_ep006_shielded_success.mp4` | Matched B6 layer-11 shielded rollout succeeds. |
| `demo_videos/pair_ep001_unshielded_fail.mp4` | Second unshielded action-noise timeout example. |
| `demo_videos/pair_ep001_shielded_success.mp4` | Second matched B6 shielded recovery success. |
